...
# Test cases: question -> tables that MUST appear in top-K results
TEST_CASES = [
    {
...
for tc in TEST_CASES:
    q = tc["question"]
    # Embed the question using the same Gemini model used for schema docs
    ...
    retrieved_tables = res["ids"][0]          # list of table names
    distances = res["distances"][0]           # cosine distances (lower = more similar)

    # Check if required tables were retrieved
